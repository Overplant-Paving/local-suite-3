...
| 57 | apod.html | space | key | nasa (demo) | C | RL (DEMO_KEY 30/hr) | ✅ `tests/evidence/apod/` |
...
| 64 | nearby.html | local | cors | — | C | RL (Overpass — TTL + mirror fallback) | ✅ `tests/evidence/nearby/` |
