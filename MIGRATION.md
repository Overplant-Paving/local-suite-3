...
|---|---|---|---|---|---|---|---|
| 1 | focus.html | time | off | — | Pilot | XP added here (was missing — data-loss fix) | ⬜ |
...
| 11 | printables.html | time | off | — | A | print CSS | ⬜ |
...
| 56 | network.html | local | cors | — | B | ipapi.co 1k/day | ⬜ |
