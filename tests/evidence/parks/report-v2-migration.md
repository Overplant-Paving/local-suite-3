# parks — historical v2 migration report (Batch C, keyed: nps, no demo tier)

> **Archived:** this report describes the former alerts-only implementation. The evidence filenames
> in this directory have since been regenerated for the v3 National Parks Explorer and no longer
> correspond to the line references below. Current evidence is summarized in `report.md` and
> `../v3-nps-explorer/report.md`.
